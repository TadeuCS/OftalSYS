...
USE OFTALDB;
CREATE TABLE ANEXO (
  CODANEXO       int(10) NOT NULL AUTO_INCREMENT, 
...
CREATE TABLE ATENDIMENTO (
  ...
  DT_ATENDIMENTO        date NOT NULL UNIQUE, 
  HORA_INICIO           time, 
  HORA_FIM              time, 
  DT_RETORNO            date, 
  QUEIXA                varchar(255), 
...
ALTER TABLE ANEXO ADD INDEX FKANEXO58480 (CODATENDIMENTO), ADD CONSTRAINT FKANEXO58480 FOREIGN KEY (CODATENDIMENTO) REFERENCES ATENDIMENTO (CODATENDIMENTO);