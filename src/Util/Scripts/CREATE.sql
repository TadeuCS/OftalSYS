...
CREATE TABLE ENDERECO (
  ...
  CODFORNECEDOR   int(10), 
  CODPACIENTE     int(10), 
  CIDADECODCIDADE int(10) NOT NULL, 
...
ALTER TABLE ENDERECO ADD INDEX FKENDERECO903068 (CIDADECODCIDADE), ADD CONSTRAINT FKENDERECO903068 FOREIGN KEY (CIDADECODCIDADE) REFERENCES CIDADE (CODCIDADE);
